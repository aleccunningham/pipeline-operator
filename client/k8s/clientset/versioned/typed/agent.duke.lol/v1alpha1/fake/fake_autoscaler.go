...
var autoscalersResource = schema.GroupVersionResource{Group: "agent.duke.lol", Version: "v1alpha1", Resource: "autoscalers"}

var autoscalersKind = schema.GroupVersionKind{Group: "agent.duke.lol", Version: "v1alpha1", Kind: "AutoScaler"}
